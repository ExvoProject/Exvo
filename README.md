...
1. Clone the Exvo source code and cd into `Exvo`

        git clone --recursive https://github.com/ExvoProject/Exvo
        cd Exvo
...
Then you can either run the command-line daemon using `src/Exvod` and `src/Exvo-cli`, or you can run the Qt GUI using `src/qt/Exvo-qt`
...
completely stable. [Tags](https://github.com/ExvoProject/Exvo/tags) are created

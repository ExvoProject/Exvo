...
#ifndef EXVO_QT_EXVOUNITS_H
#define EXVO_QT_EXVOUNITS_H
...
/** Exvo unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ExvoUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ExvoUnits(QObject *parent);

    /** Exvo units.
      @note Source: https://en.exvo.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EXVO,
...
typedef ExvoUnits::Unit ExvoUnit;

#endif // EXVO_QT_EXVOUNITS_H

...
#ifndef EXVO_WALLET_WALLET_H
#define EXVO_WALLET_WALLET_H
...
static const unsigned int DEFAULT_KEYPOOL_SIZE = 1000; //for btc it is 100
//! -paytxfee default
...
public:
     ...
     * on this exvo node, and set to 0 for transactions that were created

...
{
    BOOST_CHECK(TestSplitHost("www.exvo.org", "www.exvo.org", -1));
    BOOST_CHECK(TestSplitHost("[www.exvo.org]", "www.exvo.org", -1));
    BOOST_CHECK(TestSplitHost("www.exvo.org:80", "www.exvo.org", 80));
    BOOST_CHECK(TestSplitHost("[www.exvo.org]:80", "www.exvo.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8585", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8585", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8585", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:8585", "::", 8333));
    BOOST_CHECK(TestSplitHost("::8585", "::8585", -1));
    BOOST_CHECK(TestSplitHost(":8585", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:8585", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8585", "127.0.0.1:8585"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8585", "[::]:8585"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));

...
#ifndef EXVO_TEST_SCRIPTNUM10_H
#define EXVO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Exvo Core 0.10.0, for cross-comparison.
 */
public:

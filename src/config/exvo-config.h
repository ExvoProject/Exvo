/* src/config/exvo-config.h.  Generated from exvo-config.h.in by configure.  */
/* src/config/exvo-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef EXVO_CONFIG_H

#define EXVO_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "EXVO Developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "EXVO"
...
#define PACKAGE_BUGREPORT "https://github.com/exvo/exvo/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "EXVO Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "EXVO Core 1.14.7"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "exvo"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://exvo.info/"

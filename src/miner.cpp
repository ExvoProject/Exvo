...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn, bool fMineWitnessTx)
{
    ...
    if (nHeight > 0) {
        ...
        blockValue -= vTreasuryReward;
        coinbaseTx.vout[1].scriptPubKey = chainparams.GetTreasuryRewardScriptAtHeight(nHeight);
        coinbaseTx.vout[1].nValue = vTreasuryReward;
        //LogPrintf("[squbs] treasury payment %u\n", vTreasuryReward);
    }

...
#ifndef EXVO_VALIDATIONINTERFACE_H
#define EXVO_VALIDATIONINTERFACE_H
...
protected:
    ...
    virtual bool UpdatedTransaction(const uint256 &hash) { return false;}//TODO-- void=>bool
...
struct CMainSignals {
    ...
    boost::signals2::signal<bool (const uint256 &)> UpdatedTransaction;//TODO-- void=>bool
...
#endif // EXVO_VALIDATIONINTERFACE_H

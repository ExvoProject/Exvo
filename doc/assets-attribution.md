The following is a list of assets used in the exvo source and their proper attribution.
...
### Info
* Designer: Jonas Schnelli (based on the original exvo logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/exvo.icns, src/qt/res/src/exvo.svg,
	src/qt/res/src/exvo.ico, src/qt/res/src/exvo.png,
	src/qt/res/src/exvo_testnet.png, docs/exvo_logo_doxygen.png,

...
unlocked to sign the Exvo-Qt.app bundle.
...
allowing somebody to distribute a Exvo-Qt.app or exvo-qt-setup.exe with a valid
...
that the exvo-qt.exe file inside the installer had not been tampered with.

...
class RawTransactionsTest(ExvoTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid exvo address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid exvo address" in e.error['message'])

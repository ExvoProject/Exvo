...
import RPC call and node 0 sends EXVO to it. Then other nodes import the
...
In the second part of the test, node 0 sends more EXVO to each address, and the
...
class ImportRescanTest(ExvoTestFramework):
    def __init__(self):
        super().__init__()

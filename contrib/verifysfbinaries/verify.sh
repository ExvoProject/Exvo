...
SIGNATUREFILE="http://downloads.sourceforge.net/project/exvo/Exvo/exvo-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/exvo/Exvo/"
VERSIONPREFIX="exvo-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[exvo-]<version>-[rc[0-9]] (example: exvo-0.7.1-rc1)"
   echo "wget output:"
